    ...
    <Stack>
      ...
      >
        <Stack textAlign="left" paddingLeft={10} spacing={2}>
          <Typography color="#FFCF43" fontSize="20px"> Quick Links</Typography>
        ...
        <Stack spacing={2} textAlign="left">
          <Typography color="#FFCF43" fontSize="20px">Reach Us</Typography>
          <Typography color="white"> About Us</Typography>
          <Typography color="white"> About Us</Typography>
        </Stack>
      </Stack>
      <Stack
        ...
        justifyContent="center"
      >
        <Typography color="white" fontFamily="Inter">Connect With Us</Typography>
