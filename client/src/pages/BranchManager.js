...
export default function BranchManager () {
	return (
		<div className='BranchManager_BranchManager'>
			...
			<Link to='/totaltransactionreportpopup'>
				<div className='Rectangle23'/>
			</Link>
			<Link to='/lateloaninstalementspopup'>
			...
			<span className='ManagerPortal'>Manager Portal</span>
			<span className='LoanstoApprove'>Loans to Approve</span>
			<div className='LoanRequests'>
				<img className='Rectangle21' src = {ImgAsset.BranchManager_Rectangle21} />
				...
				<span className='Disapprove'>Disapprove</span>
			</div>
		</div>
	)
}